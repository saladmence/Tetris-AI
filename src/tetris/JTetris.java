...
public class JTetris extends JComponent {
    ...
    JTetris() {
        ...
        HashMap<String, Integer> keybinds = new HashMap<>(){{
            put("left", KeyEvent.VK_LEFT);
            put("right", KeyEvent.VK_RIGHT);
            put("down", KeyEvent.VK_DOWN);
            put("counterclockwise", KeyEvent.VK_Q);
            put("clockwise", KeyEvent.VK_W);
            put("drop", KeyEvent.VK_SPACE);
            put("hold", KeyEvent.VK_TAB);
        }};
        ...
        "left", KeyStroke.getKeyStroke(keybinds.get("left"), 0), WHEN_IN_FOCUSED_WINDOW);
        ...
        "down", KeyStroke.getKeyStroke(keybinds.get("down"), 0), WHEN_IN_FOCUSED_WINDOW);
        ...
        "right", KeyStroke.getKeyStroke(keybinds.get("right"), 0), WHEN_IN_FOCUSED_WINDOW);
        ...
        "counterclockwise", KeyStroke.getKeyStroke(keybinds.get("counterclockwise"), 0), WHEN_IN_FOCUSED_WINDOW);
        ...
        "clockwise", KeyStroke.getKeyStroke(keybinds.get("clockwise"), 0), WHEN_IN_FOCUSED_WINDOW);
        ...
        "drop", KeyStroke.getKeyStroke(keybinds.get("drop"), 0), WHEN_IN_FOCUSED_WINDOW);
        ...
        "hold", KeyStroke.getKeyStroke(keybinds.get("hold"), 0), WHEN_IN_FOCUSED_WINDOW);
